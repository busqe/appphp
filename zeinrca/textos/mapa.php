...
echo "{\"ver\": \"".$adicionar."\",\"cod\": \"".time()."\",\"api\": \"".$contar."\", \"inCodigo\": \"".$inCodigo."\",\"inTitulo\": \"".$inTitulo."\", \"inTexto\": \"".$inTexto."\",\"inIcone\": \"".$inIcone."\", \"inPublicar\": \"".$inPublicar."\",\"inLink\": \"".$inLink."\" }".$virgula." \n"; 
