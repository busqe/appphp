...
$info[5]['TITULO']="CONTATO";
$info[5]['TEXTO']="Para maiores informações sobre nossos produtos, acesse nosso site zein.com.br.";
$info[5]['ICONE']="0";
$info[5]['LINK']="0";
$info[5]['PUBLICAR']="1";
...
echo "{\"ver\": \"".$inCodigo."\",\"cod\": \"".time()."\",\"api\": \"".$contar."\", \"inCodigo\": \"".$inCodigo."\",\"inTitulo\": \"".$inTitulo."\", \"inTexto\": \"".$inTexto."\",\"inIcone\": \"".$inIcone."\", \"inLink\": \"".$inLink."\", \"inPublicar\": \"".$inPublicar."\" }".$virgula." \n"; 
